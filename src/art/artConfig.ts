...
export const artSettings: { [key: number]: ArtSetting } = {
  0: {
    ...
    description: '[Season 1] For the pioneers ready to explore the vast universe of onchain possibilities on Base.',
    tags: ['Base', 'Edu'],
  ...
  1: {
    ...baseSettings,
    name: 'Pixel Flow',
    description: '[Season 1] Theres an inner artist in you, unleash it with this tube of BasePaint!',
    tags: ['Basepaint', 'Edu'],
  ...
  2: {
    ...baseSettings,
    name: 'Stryker',
    description: '[Season 1] The Stryke Coin Trophy.',
    tags: ['Stryke', 'Skyfor'],
  ...
  3: {
    ...baseSettings,
    name: 'Frens4Ever',
    description: '[Season 1] Meet your Frenpet. Ready to spread love and joy.',
    tags: ['Frenpet', 'Soju'],
  ...
  4: {
    ...
    name: 'PoolyBank',
    description:
      '[Season 1] This quirky purple bird is here to bring a little extra luck to your PoolTogether experience. With its beak full of possibilities, it’s the perfect charm for anyone looking to save, win, and fly high with rewards!',
  ...
  5: {
    ...
    description: '[Season 1] A world of digital adventures one Dot at a time.',
  ...
  6: {
    ...
    name: 'VRBS Daily',
    description:
      '[Season 1] Each pixelated VRBS personality represents the vibrant and diverse builders creating the future of digital spaces.',
  ...
  7: {
    ...baseSettings,
    name: 'Onchain Writer',
    description: '[Season 1] Embody the freedom and creativity that Paragraph offers.',
  ...
  8: {
    ...
    description:
      '[Season 1] Zoras dynamic sphere symbolizing endless creative potential and infinite possibilities for exploration. There is art in every dimension.',
  ...
  9: {
    ...
    description: '[Season 1] Uniswaps pink temple of DeFi invites you to trade, swap, and explore with ease.',
  ...
  10: {
    ...
    description:
      '[Season 1] A seamless art piece showcasing that every layer represents fluidity and precision in blockchain, powered by Seamless Protocol.',
  ...
  11: {
    ...
    name: 'Rainbow Day',
    description:
      '[Season 1] Step into a colorful, dreamlike world where the horizon is as bright as your future in Web3. This vibrant artwork captures the spirit of exploration and wonder that comes with using Rainbow.',
  ...
  12: {
    ...
    name: 'Coin Porter CC',
    description:
      '[Season 1] With a coin in hand and a smile that says it all, this playful character embodies the fun and ease of using Reserve Protocol',
  ...
  13: {
    ...baseSettings,
    name: 'Aeroplane',
    description: '[Season 1] Hop aboard and let this adorable plane guide you through the stars of Aerodrome!',
  ...
  14: {
    ...
    description: '[Season 1] Cool vibes and good energy, thats what we Brett about.',
  ...
  15: {
    ...baseSettings,
    name: 'Higher Holder',
    description: '[Season 1] Representing ambition and progress, always aim Higher.',
  ...
  16: {
    ...
    description: '[Season 1] Portal to the Social Future',
  ...
  17: {
    ...baseSettings,
    name: 'Extra Power',
    description: '[Season 1] Go the "Extra" mile',
  ...
  18: {
    ...
    name: 'Nyan Bob Noun',
    description:
      '[Season 1] Embark on a vibrant, out-of-this-world journey with the Yellow Collectives afro-rocking icon. Channeling the limitless potential of creators through the universe and leaving a rainbow trail of inspiration.',
  ...
  19: {
    ...
    description: '[Season 1] Step into the creative playground of Phi Protocol, where you’re the artist!',
    tags: ['NFT', 'Edu', 'PHI'],
  ...
  20: {
    ...
    description:
      '[Season 1] Behold the ethereal crescent, a gateway to nocturnal wonders. This holographic moon emblem shimmers with iridescent magic, inviting you to explore the mystical realms of night. Touch to embark on a journey through dreamscapes and starlit adventures.',
    tags: ['Moonwell', 'Oz'],
  ...
  21: {
    ...baseSettings,
    name: 'Avanti-s',
    description: '[Season 1] From Atlantis to Avantis.',
  ...
  22: {
    ...
    description: '[Season 1] Capturing the excitement of reaching new heights in DeFi on Cygnus Finance.',
  ...
  23: {
    ...baseSettings,
    name: 'Build on Base',
    description: '[Season 1] Base is where you build the future of Web3.',
  ...
  24: {
    ...
    description:
      '[Season 1] A Sushiswap ship navigates a serene river, its bottom made entirely of sushi. The artwork combines the worlds of food and finance in a dreamlike, idyllic setting.',
  ...
  25: {
    ...
    description:
      '[Season 1] In a forest glade, a ghostly AAVE mother tenderly releases her baby ghosts from a transparent cylinder, as if setting them free into the world. The soft, ethereal light evokes a sense of enchantment.',
  ...
  26: {
    ...
    description:
      '[Season 1] A whimsical magical hat spills $DEGEN coins, as if Fortune herself has smiled upon the scene. The artwork exudes a sense of lighthearted joy and the promise of good fortune.',
  ...
  27: {
    ...
    name: 'BaseTag',
    description:
      '[Season 1] Whether youre repping your favorite blockchain or just want to let the world know youre BASED in all the right ways, this sticker of Jesse for Basenames is the way to go. Hand-drawn Illustration (ink on paper and digital color) by the artist Soju.',
    tags: ['Basenames', 'Soju'],
  ...
  28: {
    ...
    description:
      '[Season 1] An excited lady points to the sky, where a blazing "Highlight" airplane soars, carrying a banner that represents the thrill of discovery.',
  ...
  29: {
    ...
    name: 'Shaka Bros CC',
    description:
      '[Season 1] Love to roll through life with a smile and a trick up your sleeve? Shred on and Shaka off!',
  ...
  30: {
    ...
    name: 'Fren Chain CC',
    description:
      '[Season 1]  Feed, play, and grow your pet while embarking on exciting adventures. Show your dedication by being a responsible pet owner and watch your Frenpet thrive!',
    tags: ['Frenpet', 'Sukota'],
    externalURL: 'https://frenpet.xyz/',
